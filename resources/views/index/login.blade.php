...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased h-full">
        ...
        <div class="w-full max-w-md space-y-8">
            ...
            <h2 class="mt-6 text-center text-3xl font-normal text-gray-900 tracking-wide">LOGIN</h2>
            </div>    
            ...
            <form>
                ...
                <label class="form-check-label inline-block text-gray-800" for="exampleCheck25">Remember me</label>
                </div>
