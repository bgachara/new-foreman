...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <div class="flex min-h-full items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div class="w-full max-w-md space-y-8">
            ...
            <h2 class="mt-6 text-center text-3xl font-normal text-gray-900 tracking-wide">REGISTER</h2>
            </div>    
            <div class="block p-6 rounded-lg shadow overflow-hidden bg-white max-w-md">
            <form>
                ...
                <label class="form-check-label inline-block text-gray-800" for="exampleCheck25">Confirmed details</label>
                </div>
                ...
                <p class="text-center text-sm text-gray-500 mt-4">
                    Already have an account?
                        <a class="underline" href="{{url('login')}}">Log In</a>
                </p>
            </form>
            </div>
        </div>
